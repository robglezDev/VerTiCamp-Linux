...
```pacman -S curl```
 ...
 ## Usage
- Téléchargez la dernière version à d'[ici](https://github.com/robglezDev/VerTiCamp-linux/releases) pour votre distribution de Linux. (Seulement Arch Linux est supporté pour le moment)
